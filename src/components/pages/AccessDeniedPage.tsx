        ...
        <div className="min-h-screen bg-branco flex items-center justify-center p-4 sm:p-6">
            <div className="max-w-md w-full text-center">
                <div className="mb-6">
                    ...
                    <h1 className="text-xl sm:text-2xl font-bold text-preto mb-2">Access Restricted</h1>
                    <p className="text-verde/70 text-sm leading-relaxed">
                        Your account doesn't have access to the Meaning Map application.
                ...
                <div className="space-y-3">
                    <a
                        href="mailto:support@shemaywam.com?subject=Meaning Map Access Request"
                        className="block w-full rounded-md bg-telha px-4 py-2.5 text-sm font-medium text-white hover:bg-telha/90 transition-colors"
                    >
